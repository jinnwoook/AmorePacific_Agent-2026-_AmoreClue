...
export default function OverseasProductList({ products, selectedProduct, onSelectProduct }: OverseasProductListProps) {
  return (
    <motion.div
    ...
    >
      <div className="flex items-center gap-2 mb-4 flex-shrink-0">
        ...
        <h3 className="text-slate-900 font-bold text-xl">해외 인기 제품 리스트</h3>
      </div>

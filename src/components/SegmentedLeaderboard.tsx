...
type LeaderboardType = 'ingredient' | 'formula' | 'effect' | 'combined';
...
interface SegmentedLeaderboardProps {
  ...
  country?: Country;
  onSelectItem?: (item: BubbleItem, rank: number, type: 'ingredient' | 'formula' | 'effect' | 'combined') => void;
}
...
export default function SegmentedLeaderboard({ data, region = 'domestic', country = 'usa', onSelectItem }: SegmentedLeaderboardProps) {
  ...
  }, [activeType, ingredientData, formulaData, effectData, combinedData]);
  ...
  }, [activeType, statusFilters, displayData, ingredientData, formulaData, effectData, combinedData, getCurrentData]);
